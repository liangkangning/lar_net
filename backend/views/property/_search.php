...
<div class="row">
    <div class="col-md-1">
        ...
        //     var_dump($row);
        ?>
        <?=$form->field($model, 'category_id')->dropDownList(ArrayHelper::listDataLevel(\backend\models\Category::find()->where(['pid'=>0])->asArray()->all(), 'id', 'title','id','pid'),['prompt'=>'请选择'],['class'=>'form-control'])->label('分类'); ?>
    </div>
    <div class="col-md-2">
