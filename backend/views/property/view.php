...
<div class="property-view">
    ...
    <h3>属性：<?= Html::encode($model->title) ?></h3>
    <?= GridView::widget([
    ...
    <div class="post-form">
        ...
        <?= $form->field($new_model, 'title')->textInput(['maxlength' => true,'class'=>'clss']) ?>
        <?= $model->style==1?$form->field($new_model, 'value')->textInput(['maxlength' => true,'class'=>'clss']):''?>
...
$(function() {
/* 子导航高亮 */
highlight_subnav('property/index');
});
<?php $this->endBlock() ?>
<!-- 将数据块 注入到视图中的某个位置 -->
