...
$columns = [
    ...
    [
        ...
        'options' => ['width' => '150px;'],
        'content' => function($model){
            return $model->author_name->username;
        },
    ],
    [
        'class' => 'yii\grid\ActionColumn',
        'header' => '操作',
        'template' => '{editshenhe} {delete}',
        'options' => ['width' => '200px;'],
        'buttons' => [
            'editshenhe' => function ($url, $model, $key) {
...
<div class="portlet light portlet-fit portlet-datatable bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <div class="btn-group btn-group-devided">
                <?=Html::a('添加 <i class="fa fa-plus"></i>',array('add','category_id'=>$category_id),['class'=>'btn green','style'=>'margin-right:10px;'])?>
    ...
    <div class="portlet-body">
        ...
        <div>
            <?= $this->render('_search_shenhe', ['model' => $searchModel]); ?>
        </div>
...
highlight_subnav('articleadmin/shenhe'); //子导航高亮
});
<?php $this->endBlock() ?>
<!-- 将数据块 注入到视图中的某个位置 -->
