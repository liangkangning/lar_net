    ...
    <div class="theme-options">
        <div class="theme-option theme-colors clearfix">
            ...
            <ul>
                ...
                <li class="color-light tooltips" data-style="light" data-container="body" data-original-title="高亮"> </li>
                <li class="color-light2 tooltips" data-style="light2" data-container="body" data-html="true" data-original-title="高亮2"> </li>
            </ul>
        </div>
        ...
        <div class="theme-option">
            ...
            <select class="page-header-top-dropdown-style-option form-control input-sm">
                <option value="light" selected="selected">高亮</option>
