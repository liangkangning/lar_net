...
/* @var $model common\models\TrainCertificate */
/* @var $dataProvider yii\data\ActiveDataProvider  */
/* @var $searchModel backend\models\search\CertificateSearch */
    ...
    [
        ...
        'buttons' => [
            'edit' => function ($url, $model, $key) {
                return Html::a('<i class="fa fa-edit"></i>', ['edit','id'=>$key], [
                    'title' => Yii::t('app', '编辑'),
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <div class="btn-group btn-group-devided">
                <?=Html::a('添加 <i class="fa fa-plus"></i>',['edit'],['class'=>'btn green','style'=>'margin-right:10px;'])?>
