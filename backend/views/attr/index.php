...
$columns = [
    ...
    [
        ...
        'attribute' => 'name',
        'options' => ['width' => '100px;'],
        'content'=>function($model, $key, $index, $column) {return Html::a($model['name'],['/attr/item/','id'=>$model['id']]);},
    ...
    $data=\common\models\AttrValue::find()->where(['attr_id'=>$model['id']])->asArray()->all();
            $value_list='';
    foreach ($data as $key=>$value){
//        var_dump($value);
        $value_list=$value_list.'【'.$value['name'].'】';
    }
    return $value_list;
    },
