            ...
            <section class="section70">
                ...
                <div class="two-list">
                    ...
                    <div class="right col-md-6 col-sm-12">
                        <div class="title section30 black_color font-weight">Common 18650 Cell Prefixes</div>
                        <div class="p_ul section5">
                            <ul class="small-size light1-5">
                                <li>LCO - Lithium Cobalt Oxide(LiCoO2)</li>
                                <li>LMO - Lithium Manganese Oxide (LiMn2O4)</li>
                                <li>NMC - Lithium Nickel Manganese Cobalt Oxide (LiNiMnCoO2)</li>
                                <li>NCA - Lithium Nickel Cobalt Aluminum Oxide (LiNiCoAlO2)</li>
                                <li>LFP - Lithium Iron Phosphate(LiFePO4)</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="section80">
            ...
            <div class="p_ul section20">
                <ul class="small-size light1-5">
                    ...
                    <li class="section5">After the lithium battery pack is formed, the battery voltage and capacity will be greatly increased, so it must be protected. It also needs charging balance, temperature, voltage and overcurrent monitoring.</li>
                    <li class="section5">The battery pack needs to meet the design requirements of voltage and capacity.</li>
                </ul>
            </div>
        </section>
