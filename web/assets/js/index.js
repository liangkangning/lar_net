...
$(function () {
    ...
    $('.fang').slide({ titCell: ".fa_nav li", mainCell: ".fang_c", targetCell: ".fa_nav ul p", effect: "fold", autoPlay: false, titOnClassName: "cur" });

    $('.pro').slide({ mainCell: ".pro_c ul", effect: "leftLoop", autoPlay: true, vis: 3, prevCell: ".p_z", nextCell: ".p_y" });

    $('.case_bg').slide({ mainCell: ".case_c ul", effect: "leftLoop", autoPlay: true, vis: 3, prevCell: ".case_z", nextCell: ".case_y" });

    //$('.jz').slide({ mainCell: ".jz_c ul", effect: "leftLoop", autoPlay: true, vis: 3, prevCell: ".case_z", nextCell: ".case_y" });

    $('.coo_bg').slide({ mainCell: ".coo_c ul", effect: "leftLoop", autoPlay: true, vis: 4, prevCell: ".case_z", nextCell: ".case_y" });
