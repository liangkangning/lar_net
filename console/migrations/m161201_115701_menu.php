...
class m161201_115701_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%menu}}',['id'=>'6','title'=>'改变状态','pid'=>'3','sort'=>'0','url'=>'article/setStatus','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'7','title'=>'保存','pid'=>'3','sort'=>'0','url'=>'article/update','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'8','title'=>'保存草稿','pid'=>'3','sort'=>'0','url'=>'article/autoSave','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'9','title'=>'移动','pid'=>'3','sort'=>'0','url'=>'article/move','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'139','title'=>'潜水管理','pid'=>'2','sort'=>'22','url'=>'shop/index?type=3','hide'=>'0','group'=>'商城管理|icon-basket','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'156','title'=>'添加培训','pid'=>'2','sort'=>'0','url'=>'train/add','hide'=>'1','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'157','title'=>'编辑培训','pid'=>'2','sort'=>'0','url'=>'train/edit','hide'=>'1','group'=>'','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'152','title'=>'删除商品','pid'=>'2','sort'=>'0','url'=>'shop/delete','hide'=>'1','group'=>'','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'150','title'=>'添加商品','pid'=>'2','sort'=>'0','url'=>'shop/add','hide'=>'1','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'151','title'=>'编辑商品','pid'=>'2','sort'=>'0','url'=>'shop/edit','hide'=>'1','group'=>'','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'143','title'=>'海钓管理','pid'=>'2','sort'=>'23','url'=>'shop/index?type=4','hide'=>'0','group'=>'商城管理|icon-basket','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'142','title'=>'前台用户','pid'=>'16','sort'=>'20','url'=>'user/index','hide'=>'0','group'=>'前台用户|icon-users','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'141','title'=>'帆船管理','pid'=>'2','sort'=>'21','url'=>'shop/index?type=2','hide'=>'0','group'=>'商城管理|icon-basket','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'80','title'=>'分类管理','pid'=>'2','sort'=>'2','url'=>'category/index','hide'=>'0','group'=>'文章管理|icon-note','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'81','title'=>'编辑','pid'=>'80','sort'=>'0','url'=>'category/edit','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'82','title'=>'新增','pid'=>'80','sort'=>'0','url'=>'category/add','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'83','title'=>'删除','pid'=>'80','sort'=>'0','url'=>'category/remove','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'84','title'=>'移动','pid'=>'80','sort'=>'0','url'=>'category/operate/type/move','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'85','title'=>'合并','pid'=>'80','sort'=>'0','url'=>'category/operate/type/merge','hide'=>'0','group'=>'','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'106','title'=>'行为日志','pid'=>'16','sort'=>'30','url'=>'log/index','hide'=>'0','group'=>'用户日志|icon-check','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'110','title'=>'查看行为日志','pid'=>'106','sort'=>'0','url'=>'log/view','hide'=>'1','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'114','title'=>'导入','pid'=>'75','sort'=>'0','url'=>'Menu/import','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'149','title'=>'培训课程','pid'=>'2','sort'=>'51','url'=>'train/index','hide'=>'0','group'=>'培训管理|fa fa-certificate','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'138','title'=>'酒店管理','pid'=>'2','sort'=>'20','url'=>'shop/index?type=1','hide'=>'0','group'=>'商城管理|icon-basket','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'158','title'=>'删除培训','pid'=>'2','sort'=>'0','url'=>'train/delete','hide'=>'1','group'=>'','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'163','title'=>'证书管理','pid'=>'2','sort'=>'0','url'=>'certificate/index','hide'=>'0','group'=>'培训管理|fa fa-certificate','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'164','title'=>'添加/修改证书','pid'=>'163','sort'=>'0','url'=>'certificate/edit','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'165','title'=>'删除证书','pid'=>'163','sort'=>'0','url'=>'certificate/delete','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'166','title'=>'培训类型','pid'=>'2','sort'=>'0','url'=>'traintype/index','hide'=>'0','group'=>'培训管理|fa fa-certificate','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'169','title'=>'商城管理','pid'=>'2','sort'=>'0','url'=>'shop/index','hide'=>'1','group'=>'','status'=>'1']);
