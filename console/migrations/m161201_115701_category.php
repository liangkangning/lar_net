...
class m161201_115701_category extends Migration
{
    public function up()
    {
        ...
        /* 索引设置 */
        $this->createIndex('uk_name','{{%category}}','name',1);
        $this->createIndex('pid','{{%category}}','pid',0);
        ...
        $this->insert('{{%category}}',['id'=>'7','pid'=>'4','name'=>'lianxi3','title'=>'联系我们3','link'=>'','extend'=>'','meta_title'=>'','keywords'=>'','description'=>'','create_time'=>'1479374778','update_time'=>'0','sort'=>'0','status'=>'1']);
